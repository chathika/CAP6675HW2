  ...
  ask patches [
    if random 100 < density [   ;; set the occupancy density
      sprout 1 [
        ...
        set age max list 0 (min list 90 (random-normal 30 20))
        ifelse Mode = "Normal"
        [set %-similar-wanted %-similar-wanted-max]
        [set %-similar-wanted min list 100  (%-similar-wanted-max * age / 90)]
